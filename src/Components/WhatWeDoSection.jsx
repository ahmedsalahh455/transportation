  ...
  return (
    <div className={`py-6 md:py-12 ${isHomepage ? '' : 'bg-white'}`}>
      {isHomepage ? (
        ...
        >
          <div className="absolute inset-0 bg-[rgba(1,35,87,0.85)]"></div>

          <div className="relative z-10 max-w-[90%] mx-auto flex flex-col md:flex-row items-center justify-center gap-8 py-12">
